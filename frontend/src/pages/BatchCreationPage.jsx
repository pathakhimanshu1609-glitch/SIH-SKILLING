  ...
  const loadFormDependencies = async () => {
    ...
    try {
      ...
      const loadedCandidates = candRes.candidates?.length ? candRes.candidates : [
        { id: 'cand-01', full_name: 'Ananya Sharma', email: 'ananya@gmail.com', preferred_trade: 'Advanced CNC Machinist', qualification: 'ITI Machinist' },
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-950 via-govt-navy to-slate-900 text-white rounded-xl p-6 shadow-govt-card relative overflow-hidden">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-lg bg-purple-600 text-white flex items-center justify-center font-bold">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-purple-200">Apex Industrial Training Institute</span>
            </div>
            <h1 className="text-xl font-bold font-roboto">Create & Allocate Skill Training Batch</h1>
            <p className="text-xs text-slate-300">Assign curriculum trades, link industry employers for placements, and enroll verified candidates.</p>
          </div>
        </div>
      </div>
      ...
      {successMsg && (
        <div className="bg-emerald-50 border border-emerald-300 text-emerald-900 p-4 rounded-xl text-xs flex items-center gap-3 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-700 mt-0.5">The batch is now active on the national portal and visible to government auditors and corporate recruiters.</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                ...
                <h2 className="text-xs font-bold text-slate-800 uppercase tracking-wider">1. Batch Code & Information</h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 text-xs rounded-md p-2.5 font-mono font-bold text-govt-navy"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-50 border border-slate-300 text-xs rounded-md p-2.5"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                ...
                <h2 className="text-xs font-bold text-slate-800 uppercase tracking-wider">2. Assign Curriculum Trade & Skills</h2>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-50 border border-slate-300 text-xs font-bold text-slate-800 rounded-md p-2.5 focus:ring-1 focus:ring-purple-600"
                >
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                ...
                <h2 className="text-xs font-bold text-slate-800 uppercase tracking-wider">3. Link Partner Corporate Employer</h2>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-50 border border-slate-300 text-xs font-bold text-emerald-900 rounded-md p-2.5"
                >
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-xs font-bold text-slate-800 uppercase tracking-wider">4. Enroll Candidates into Batch</h2>
                </div>
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-lg border text-xs cursor-pointer flex items-center justify-between transition-all ${
                        isSelected 
                          ? 'border-purple-600 bg-purple-50/70 font-semibold text-purple-950' 
                    ...
                    >
                      ...
                      <span className={`text-[10px] px-2 py-0.5 rounded font-mono ${isSelected ? 'bg-purple-200 text-purple-900 font-bold' : 'bg-slate-200 text-slate-600'}`}>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full btn-govt-primary py-3 text-xs font-bold uppercase tracking-wider shadow-md hover:shadow-lg"
            >
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4 sticky top-20">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 border-b border-slate-100 pb-2">
              Live Allocation Preview
            </h3>

            <div>
              <span className="text-[10px] font-mono font-bold bg-govt-navy text-white px-2 py-0.5 rounded">
                {formData.batch_code || 'CODE'}
              </span>
              <h4 className="text-sm font-bold text-slate-800 mt-1">{formData.batch_title || 'Untitled Batch'}</h4>
            ...
            <div className="space-y-1">
              ...
              <div className="space-y-1.5 pt-1">
                {selectedTradeObj?.skills?.map((s, idx) => (
                  <div key={idx} className="p-2 rounded bg-slate-50 border border-slate-200 text-xs flex items-center gap-2">
