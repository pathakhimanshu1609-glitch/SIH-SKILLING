    ...
    <div className="max-w-6xl mx-auto space-y-8 font-sans">
      ...
      <div className="bg-[#0B3D6B] border border-[#072847] text-white rounded-xl p-6 sm:p-8 relative shadow-sm overflow-hidden">
        <div className="flex items-center gap-4 relative z-10">
          <div className="w-12 h-12 rounded-xl bg-[#072847] border border-[#D2691E]/30 text-[#D2691E] flex items-center justify-center font-bold shadow-xs">
            <Building2 className="w-6 h-6" />
          </div>
          <div>
            <div className="flex items-center gap-2 mb-1.5 flex-wrap">
              <span className="bg-[#072847] text-[#D2691E] border border-[#D2691E]/30 text-[10px] uppercase font-bold px-2.5 py-0.5 rounded tracking-wider">
                TC BATCH ALLOCATION
              </span>
              <span className="text-xs text-blue-200 font-medium">Apex Industrial Training Institute</span>
            </div>
            <h1 className="text-xl sm:text-2xl font-bold font-display text-white tracking-tight">Create & Allocate Skill Training Batch</h1>
            <p className="text-xs sm:text-sm text-slate-300 mt-1">Assign curriculum trades, link industry employers for placements, and enroll verified candidates.</p>
          </div>
        </div>
      </div>
      ...
      {/* Success Banner */}
      {successMsg && (
        <div className="banner-peach p-5 rounded-xl text-xs flex items-center gap-3.5 shadow-xs border">
          <CheckCircle2 className="w-5 h-5 text-emerald-600 flex-shrink-0" />
          <div>
            <p className="font-bold text-sm font-display text-[#8C3A00]">{successMsg}</p>
            <p className="text-xs text-[#8C3A00]/80 mt-0.5">The batch is now active on the national portal and visible to government auditors and corporate recruiters.</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                <Layers className="w-4 h-4 text-[#0B3D6B]" />
                <h2 className="text-xs font-bold font-display text-slate-900 uppercase tracking-wider">1. Batch Code & Information</h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 text-xs rounded-lg p-2.5 font-mono font-bold text-[#0B3D6B] focus:ring-2 focus:ring-[#D2691E] focus:border-[#D2691E] focus:bg-white transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-50 border border-slate-300 text-xs rounded-lg p-2.5 focus:ring-2 focus:ring-[#D2691E] focus:border-[#D2691E] focus:bg-white transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-300 text-xs rounded-lg p-2.5 text-slate-800 focus:ring-2 focus:ring-[#D2691E] focus:border-[#D2691E] focus:bg-white transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                <BookOpen className="w-4 h-4 text-[#0B3D6B]" />
                <h2 className="text-xs font-bold font-display text-slate-900 uppercase tracking-wider">2. Assign Curriculum Trade & Skills</h2>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-50 border border-slate-300 text-xs font-bold text-slate-800 rounded-lg p-2.5 focus:ring-2 focus:ring-[#D2691E] focus:border-[#D2691E] focus:bg-white transition-all"
                >
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center gap-2">
                ...
                <h2 className="text-xs font-bold font-display text-slate-900 uppercase tracking-wider">3. Link Partner Corporate Employer</h2>
              </div>
            ...
            <div className="space-y-4">
              <div className="pb-2 border-b border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4 text-[#0B3D6B]" />
                  <h2 className="text-xs font-bold font-display text-slate-900 uppercase tracking-wider">4. Enroll Candidates into Batch</h2>
                </div>
                <span className="text-[11px] font-bold text-[#0B3D6B] bg-[#E8ECFB] px-2.5 py-0.5 rounded-full border border-[#D1DBF7]">
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl border text-xs cursor-pointer flex items-center justify-between transition-all ${
                        isSelected 
                          ? 'border-[#D2691E] bg-[#FDEEE0] font-semibold text-slate-900 shadow-xs' 
                          : 'border-slate-200 bg-slate-50 text-slate-700 hover:bg-slate-100 hover:border-slate-300'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-5 h-5 rounded-md flex items-center justify-center border transition-colors ${
                          isSelected ? 'bg-[#D2691E] border-[#D2691E] text-white' : 'border-slate-300 bg-white'
                        }`}>
                      ...
                      <span className={`text-[10px] px-2.5 py-0.5 rounded-md font-mono ${isSelected ? 'bg-[#D2691E] text-white font-bold' : 'bg-slate-200 text-slate-600'}`}>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 sm:p-8 space-y-5 sticky top-20">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold bg-[#0B3D6B] text-white px-2.5 py-0.5 rounded tracking-wider">
              ...
              <p className="text-xs text-[#0B3D6B] font-bold mt-0.5">{formData.trade_name}</p>
            </div>
              ...
              <div className="space-y-2 pt-1">
                {selectedTradeObj?.skills?.map((s, idx) => (
                  <div key={idx} className="p-2.5 rounded-lg bg-slate-50 border border-slate-200 text-xs flex items-center gap-2">
                    <Target className="w-3.5 h-3.5 text-[#D2691E]" />
            ...
            <div className="pt-3 border-t border-slate-100 flex justify-between items-center text-xs">
              ...
              <span className="font-bold text-[#0B3D6B] font-mono text-sm">
